...
void main() => runApp(MaterialApp(home: ProdutoPage(), debugShowCheckedModeBanner: false,)); //uso do callback
...
class _ProdutoPageState extends State<ProdutoPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Cadastro de Produtos"),centerTitle: true,backgroundColor: Colors.blue,),
      body: Padding(
